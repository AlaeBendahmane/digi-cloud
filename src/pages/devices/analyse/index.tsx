            ...
            <div className="grid grid-cols-2 gap-2 mt-3">
                <div className='bg-gray-200 rounded-sm flex flex-col justify-center items-center '>
                    ...
                    <div className="flex flex-wrap sm:justify-center">
                        <p className='my-1 font-light text-sm'>Min:21.6C</p>
                        <img src={Circle} alt="" className='m-1' />
                        <p className='my-1 font-light text-sm'>Max:22.5C</p>
                    </div>
                </div>
                <div className='bg-red-100 rounded-sm flex flex-col justify-center items-center '>
                    ...
                    <div className="flex flex-wrap sm:justify-center">
                        <p className='my-1 font-light text-sm'>Min:25.8%</p>
                        <img src={Circle} alt="" className='m-1' />
                        <p className='my-1 font-light text-sm'>Max:25.8%</p>
                    </div>
                </div>
            </div>
        </Card>
